...
Os artefatos generalistas auxiliam na compreensão do problema e na definição de soluções, independentemente da metodologia adotada. Nesse processo, a equipe gerou 3 artefatos generalistas: **Rich Picture**, **5W2H** e **Mapa Mental**. Esses artefatos foram produzidos durante a etapa de [Sketch](./DesignSprint/Sketch.md) do Design Sprint [1].
...
Neste projeto, o Rich Picture foi elaborado **a partir da perspectiva de uma persona** definida na etapa de [Unpack](./DesignSprint/Unpack.md). Ao adotar o ponto de vista de um usuário representativo — com suas dores, necessidades e contexto de uso — foi possível mapear de forma mais realista o cenário do problema, identificando os atores envolvidos, as relações entre eles e os problemas que enfrentam.
