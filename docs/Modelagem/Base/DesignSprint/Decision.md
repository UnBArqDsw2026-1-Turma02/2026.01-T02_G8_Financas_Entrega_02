...
A etapa de **Decision** é a terceira fase do Design Sprint, conforme proposto por Jake Knapp [1]. Após a divergência criativa realizada na fase de [Sketch](Sketch.md), esta etapa tem como objetivo **convergir e decidir** quais soluções serão levadas adiante [1]. A equipe analisa as ideias geradas anteriormente e seleciona as mais promissoras para serem prototipadas e testadas. As soluções propostas no Sketch — por meio dos artefatos de [Rich Picture, 5W2H e Mapa Mental](Sketch.md) — foram analisadas e priorizadas para compor o escopo do projeto. Essa etapa é responsável por guiar o desenvolvimento do projeto, servindo de insumo direto para a construção do [Protótipo](Prototype.md) e para os processos de [Verificação](Verificacao.md) e [Validação](Validacao.md).

## Metodologia

A metodologia selecionada para a decisão foi a produção do Product Backlog[2], que é uma lista ordenada de funcionalidades que serão desenvolvidas no projeto. O backlog foi estruturado em níveis hierárquicos de Theme, Epic, Feature e User Story, seguindo práticas de mapeamento de histórias de usuário[3]. Os itens do backlog foram originados a partir dos artefatos produzidos nas etapas de [Unpack](Unpack.md) e [Sketch](Sketch.md) — como a Instrospecção, as Personas, o Rich Picture, o 5W2H e o Mapa Mental — conforme documentado na [Matriz de Rastreabilidade](MatrizRastreabilidade.md).
...
[2] BECK, Kent et al. **Manifesto para Desenvolvimento Ágil de Software**. 2001. Disponível em: https://agilemanifesto.org/iso/ptbr/manifesto.html. Acesso em: 23 mar. 2026.

[3] COHN, Mike. **User Stories Applied: For Agile Software Development**. Addison-Wesley, 2004. ISBN: 978-0321205681.
...
| 2.0 | 12/04/2026 | Adição de referencias e rastreabilidade| Equipe G8 |