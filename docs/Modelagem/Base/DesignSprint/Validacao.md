...
O teste de usabilidade é um método de avaliação que envolve a participação de usuários representativos para realizar tarefas em um sistema, com o objetivo de identificar problemas de usabilidade e coletar dados sobre a experiência de uso [2]. Segundo Barbosa et al. [2], esse método é fundamental para validar se a interface atende às necessidades dos usuários e se os fluxos de interação são intuitivos e eficientes.
...
[2] BARBOSA, Simone D. J. et al. **Interação Humano-Computador e Experiência do Usuário**. Autopublicação, 2021. Capítulo 12 — Métodos de Avaliação de IHC. ISBN: 978-65-00-19677-1.
