...
![diagrama-de-pacotes](./assets/pacotesv2.png)

<b>Imagem 1:</b> Diagrama de Pacotes do sistema, VERSÃO 1.

</div>

Após considerações junto a Professora Milene, foi observado que faltavam alguns elementos no diagrama, como a especificação das relações entre os pacotes por meio dos stereotypes. Além disso, temos dois pacotes FrontEnd e BackEnd, o que tornou ambíguo a visão geral do sistema, precisando de uma especificação mais clara. Com isso, um novo diagrama foi gerado, por não ficar totalmente claro como será a relação de dependência entre os pacotes, foi utilizado apenas <<use>> para indicar a dependência entre os pacotes, em sua maioria.

<div align="center">

![diagrama-de-pacotes](./assets/pacotes.png)

<b>Imagem 2:</b> Diagrama de Pacotes do sistema, VERSÃO 2.
