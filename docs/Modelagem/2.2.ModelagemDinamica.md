...
O **Diagrama de Sequência** é um diagrama comportamental da UML (*Unified Modeling Language*) que mostra como os objetos de um sistema conversam ao longo do tempo, destacando a ordem das mensagens trocadas entre eles [1][2]. Por mostrar *como* um cenário acontece em tempo de execução, é um dos diagramas mais usados na fase de projeto [1][3].
